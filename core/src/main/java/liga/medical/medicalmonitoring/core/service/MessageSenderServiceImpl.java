...
public class MessageSenderServiceImpl implements MessageSenderService {
    ...
    public void sendError(String message) {
        amqpTemplate.convertAndSend(MessageQueueNames.ERROR_QUEUE_NAME, message);
        log.info("Сообщение об ошибке [{}] отправлено в очередь [{}]", message, MessageQueueNames.ERROR_QUEUE_NAME);
    }
}
